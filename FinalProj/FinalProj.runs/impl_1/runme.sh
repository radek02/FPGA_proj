...
HD_PWD='/home/radek/MINI/FPGA/FinalProj/FinalProj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log time_counter_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source time_counter_top.tcl -notrace
