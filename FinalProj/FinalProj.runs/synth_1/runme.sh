...
HD_PWD='/home/radek/MINI/FPGA/FinalProj/FinalProj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log time_counter_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source time_counter_top.tcl
